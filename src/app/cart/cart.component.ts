...
// home.ts: items = [{item}]
//home.html: ngFor
// (click) - mis kutsub välja home.ts ja saadab selle eseme millel klikkisin sinna funktsiooni
...
//ANDMISE POOL TEHTUD - SERVISE s on olemas pärast igat vajutust sobiva esemed
